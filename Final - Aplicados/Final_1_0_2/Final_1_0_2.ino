        ...
        if (distancia < DistN2 && distancia > DistN1){
          ...
          if (distancia < DistN3 && distancia > DistN2){
            ...
            if (distancia < DistMax && distancia > DistN3){
              lcd.write((byte)4);
              while(distancia > DistMin){     // Este while activa la bomba para carga el tanque
                digitalWrite(pinReleBomba, HIGH);
                lcd.write("Cargando tanque");
              }
              digitalWrite(pinReleBomba, LOW); //Para desactivar la bomba cuando salga del while.
            } else {
              lcd.clear();
