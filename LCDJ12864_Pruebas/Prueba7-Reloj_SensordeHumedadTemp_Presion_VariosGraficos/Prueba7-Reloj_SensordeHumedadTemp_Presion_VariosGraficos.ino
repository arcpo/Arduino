/*
 * Prueba de distintos gráficos en el display, hasta ahora solo tenía un solo gráfico.
 */
...
void setup() {
  ...
  Serial.print("Prueba7-Reloj_SensordeHumedadTemp_presion_VariosGraficos");
